...
public class PostController {
     ...
     */
    @PostMapping
    public Response<PostVO> createPost(@RequestBody @Valid PostCreateVO postVO,
    ...
    public Response<Page<PostVO>> getPostsByForum(@PathVariable Integer forumId,
    ...
    public Response<PostVO> likePost(@PathVariable Integer postId,
                             @RequestAttribute("userId") Integer userId) {
