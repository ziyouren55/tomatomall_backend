...
import com.example.tomatomall.vo.accounts.UserSchoolVO;
...
public class AccountController {
     ...
     */
    @GetMapping("/{username}")
    public Response<AccountVO> getUser(@PathVariable("username") String username) {
    ...
    public Response<Map<String, Object>> getUserProfile(@PathVariable("username") String username) {
     ...
     */
    @GetMapping("/id/{id}")
    public Response<AccountVO> getUserById(@PathVariable("id") Integer id) {
    ...
    public Response<UserSchoolVO> getUserSchool(@PathVariable("username") String username) {
        return Response.buildSuccess(accountService.getUserSchool(username));
    }

    @GetMapping("/id/{id}/school")
    public Response<UserSchoolVO> getUserSchoolById(@PathVariable("id") Integer id) {
        return Response.buildSuccess(accountService.getUserSchoolById(id));
    }

    @GetMapping("/id/{id}/profile")
    public Response<Map<String, Object>> getUserProfileById(@PathVariable("id") Integer id) {
     ...
     */
    @PutMapping()
    public Response<AccountVO> updateUser(@RequestBody AccountVO accountVO) {
    ...
    public Response<SchoolVerificationVO> submitSchoolVerification(@RequestBody SchoolVerificationVO vo) {
    ...
    public Response<SchoolVerificationVO> getSchoolVerification(@PathVariable("username") String username) {
